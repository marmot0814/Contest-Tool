...
\newcommand{\problem}[4] % dir, title, time, memory
{
	...
	\field{#1}{Problem Description}{tex/statement.tex}

	\field{#1}{Input Format}{tex/input.tex}
	\field{#1}{Output Format}{tex/output.tex}
	\field[0]{#1}{Technical Specification}{tex/spec.tex}
	\vspace{3mm}
	\testdata{#1}
	\field[0]{#1}{Hint}{tex/hint.tex}
	\field[0]{#1}{Note}{tex/note.tex}
	\newpage
}
...
\begin{center}
    \begin{tabular}{clc}
        ...
        \midrule
            ...
            \problemList{A}{Hello World A}{1}{2048}
            \problemList{B}{Hello World B}{1}{2048}
            \problemList{C}{Hello World C}{1}{2048}
            \problemList{D}{Hello World D}{1}{2048}
        \bottomrule
    \end{tabular}
\end{center}
\thispagestyle{empty}
...
\problem{A}{Hello World A}{1}{2048}
\problem{B}{Hello World B}{1}{2048}
\problem{C}{Hello World C}{1}{2048}
\problem{D}{Hello World D}{1}{2048}
